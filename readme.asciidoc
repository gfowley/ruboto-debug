...
----
total 28K
drwxrwxr-x 4 gerard gerard 4.0K Sep 15 08:57 linecache-1.3.1.pre-java
-rw-rw-r-- 1 gerard gerard  23K Sep 15 08:57 linecache-1.3.1.pre-java.gem
----
...
removed ‘gemdir/gems/linecache-1.3.1.pre-java.gem’
‘../linecache/pkg/linecache-1.3.1.pre-java.gem’ -> ‘gemdir/gems/linecache-1.3.1.pre-java.gem’
...
Successfully uninstalled linecache-1.3.1.pre-java
Fetching source index from file:/home/gerard/dev/ruboto-debug/gemdir/
Resolving dependencies...
Using columnize 0.9.0
Installing linecache 1.3.1.pre
